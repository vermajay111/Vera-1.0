...
import { Sparkles, Users, Handshake, ShieldCheck } from "lucide-react";

// Landing page that integrates your AppSidebar + Breadcrumb and matches the auth theme
export default function Landing() {
  return (
    <SidebarProvider>
      ...
      <SidebarInset>
        {/* Header with SidebarTrigger + Breadcrumb (matches other pages) */}
        ...
        <main className="relative min-h-[calc(100vh-4rem)] bg-gradient-to-b from-black via-[#0a0710] to-black text-white overflow-x-hidden">
          <section className="max-w-7xl mx-auto px-6 lg:px-8 py-14 lg:py-20">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-6 space-y-6">
                ...
                >
                  ...
                  currency, confirm completion as a group, and build a
                  reliability reputation that follows you.
                </motion.p>
                ...
                <div className="mt-6 flex gap-6 flex-wrap items-center">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-400">
                        AI mediation & judge marketplace
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="lg:col-span-6 flex justify-center lg:justify-end">
                ...
                >
                  ...
                  <motion.div
                    ...
                    className="absolute -bottom-10 left-6 flex gap-3"
                  >
                    <div className="flex items-center gap-2 bg-zinc-800/50 border border-zinc-700 rounded-full px-3 py-2">
              ...
              {[
                {
                  ...
                  desc: "Invite friends, set stakes, and lock commitments.",
                  icon: Users,
                },
                {
                  title: "Finish or Conflict",
                  desc: "Group confirmations or enter Conflict Mode for fair resolution.",
                  icon: Handshake,
                },
                {
                  title: "AI + Judges",
                  desc: "AI mediation first, then a judge marketplace if needed.",
                  icon: ShieldCheck,
                },
                {
                  title: "Reputation & Badges",
                  desc: "Track reliability, earn trust and show your streaks.",
                  icon: Sparkles,
                },
              ].map((f, i) => (
                <motion.div
            ...
            <div className="mt-20 text-center">
              ...
              >
                Join Vera to turn trust into trackable currency — your
                reputation will follow your word.
              </motion.p>
