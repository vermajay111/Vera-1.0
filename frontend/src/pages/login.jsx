...
export default function Login({ className, ...props }) {
  ...
  const mutation = useMutation({
    ...
    onSuccess: (data, variables) => {
      ...
      Cookies.set("profile_photo", data.user.avatar_url);
      Cookies.set("bio", data.user.bio);
      Cookies.set("tokenCount", data.user.token_count)
      dispatch(user_refresh());
      dispatch(token_refresh());
      navigate("/home");
      toast(`You have been sucesfully logged in, ${data.user.username}`)
    },
    onError: () => {},
  });
